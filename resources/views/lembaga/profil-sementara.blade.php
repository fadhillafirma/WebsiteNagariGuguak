    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .hero-bg {
            ...
            background: url('{{ asset('cover-upz.jpg') }}') center/cover no-repeat fixed;
            z-index:1;
        }
        .hero-overlay {
            position:absolute; inset:0;
    ...
    <section id="hero">
        ...
        <div class="hero-inner">
            <div class="hero-text">
                ...
                <h1 class="hero-title">
                    Tunaikan Zakat,<br>Wujudkan <em>Kepedulian</em> Sosial
                </h1>
                <p class="hero-desc">
                    UPZ Nagari Guguak hadir sebagai lembaga amil zakat yang amanah dan transparan.
                    Bersama, kita wujudkan pemerataan kesejahteraan bagi seluruh masyarakat Nagari Guguak.
                </p>
                <div class="hero-acts">
                    <a href="#cta" class="btn-gold">Bayar Zakat Sekarang</a>
                    <a href="#program" class="btn-outline">Lihat Program Kerja</a>
                </div>
            </div>
        </div>
        ...
        <div class="sec-inner">
            <div class="berita-header">
                <div class="reveal">
                    ...
                    <h2 class="sec-title" style="margin-bottom:0">Informasi Terkini dari UPZ</h2>
                </div>
