...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .nav-brand-sub { font-size:11px; color:var(--text-sub); font-weight:400; }
        ...
        .berita-card-image .card-overlay {
            position: absolute; inset: 0;
            background: linear-gradient(180deg, transparent 40%, rgba(0,30,15,0.5) 100%);
            z-index: 1;
        }
...
<body>
    ...
    <nav id="site-nav">
        <a href="{{ route('lembaga.beranda', ['lembaga' => $subdomain]) }}" class="nav-brand">
            <img id="nav-logo-img" src="{{ asset('baznas.png') }}" alt="Baznas Logo" style="height: 60px; object-fit: contain; transition: height 0.3s;">
        </a>
        <ul class="nav-links">
            ...
            <li><a href="{{ route('lembaga.berita.index', ['lembaga' => $subdomain]) }}" class="active">Berita</a></li>
        </ul>
    </nav>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            ...
            <p class="page-hero-desc">Informasi terkini seputar kegiatan, penyaluran dana zakat, dan berita penting dari UPZ Nagari Guguak.</p>
        </div>
    </section>
    ...
    <div class="list-section">
        ...
        <div class="berita-card" style="animation-delay: {{ $index * 0.12 }}s;">
            ...
            <div class="berita-card-body">
                ...
                <a href="{{ route('lembaga.berita.show', ['lembaga' => $subdomain, 'berita' => \Illuminate\Support\Str::slug($berita->judul)]) }}" class="btn-detail">
                    Lihat Detail
    ...
    <footer>
        ...
        <div class="foot-bottom">
            <p>&copy; 2026 <span>UPZ Nagari Guguak</span>. Bagian dari ekosistem digital Nagari Guguak.</p>
