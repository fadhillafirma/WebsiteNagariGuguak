...
<section class="py-20 px-8 bg-white max-w-7xl mx-auto">
    <h2 class="font-bold text-greenDark text-4xl underline underline-offset-4 text-center mt-10">Potensi Nagari</h2>
                    ...
                    <a href="{{ route('potensi.show', $potensi->id) }}">
                        <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition duration-300">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-sm text-gray-500 mb-2">{{ \Illuminate\Support\Str::limit($potensi->deskripsi, 10) }}</p>
                            </div>
                        </div>
                    </a>
                @endforeach
