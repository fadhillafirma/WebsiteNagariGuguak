...
<head>
    ...
    <title>{{ $program->nama_program }} â€“ {{ $info['nama'] }}</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .nav-links a {
            display:inline-block; background: transparent; border:1px solid rgba(255,255,255,0.3);
            color: var(--white); padding: 8px 18px; border-radius:4px;
            font-weight:600; font-size:12px; text-decoration:none; transition: 0.2s;
        }
        .nav-links a:hover { background: rgba(255,255,255,0.1); border-color:var(--white); }
        ...
        .back-link {
            ...
            font-size:13px; font-weight:600; color:var(--maroon-mid);
        ...
        .d-title {
            font-size: clamp(28px, 4vw, 42px); font-weight: 700; color: var(--maroon-dark);
        ...
        .meta-val { font-size:14px; font-weight:600; color:var(--maroon-dark); }
        ...
        /* FOOTER */
        footer { background:#2C070E; color:rgba(255,255,255,0.55); padding:40px 6%; text-align:center; font-size:12px; }
...
<body>
    ...
    <nav id="site-nav">
        ...
        <div class="nav-links">
            <a href="{{ route('lembaga.beranda', ['lembaga' => 'bpn']) }}#program">Daftar Program</a>
        </div>
    </nav>

    <div class="detail-wrapper">
        <a href="{{ route('lembaga.program.index', ['lembaga' => 'bpn']) }}" class="back-link">
        ...
        <div class="d-meta">
            ...
            <div class="meta-item">
                ...
                <span class="meta-val" style="color:{{ $program->status == 'aktif' ? 'var(--maroon-mid)' : 'var(--text-sub)' }}; text-transform:capitalize;">{{ $program->status }}</span>
            </div>
        </div>
