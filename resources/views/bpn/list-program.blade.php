    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .program-card-image .card-overlay {
            position: absolute; inset: 0;
            background: linear-gradient(180deg, transparent 40%, rgba(38,5,11,0.6) 100%);
            z-index: 1;
        }
...
<body>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            ...
            <p class="page-hero-desc">Informasi dan laporan kegiatan BPN dalam mewujudkan tata kelola nagari yang transparan dan partisipatif.</p>
        </div>
    </section>
        ...
        <div class="foot-grid">
            ...
            <div>
                ...
                <ul class="foot-ul">
                    ...
                    <li><a href="#">bpn@nagariguguak.id</a></li>
                </ul>
            </div>
        </div>
        <div class="foot-bottom">
            <p>&copy; 2025 <span>BPN Nagari Guguak</span>. Bagian dari ekosistem digital Nagari Guguak.</p>
