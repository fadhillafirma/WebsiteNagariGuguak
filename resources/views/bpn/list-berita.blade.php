...
<body>
    ...
    <nav id="site-nav">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ route('bpn.program.index') }}">Program</a></li>
            <li><a href="{{ route('bpn.berita.index') }}" class="active">Berita</a></li>
        </ul>
    </nav>
    ...
    <div class="list-section">
        ...
        <div class="berita-card" style="animation-delay: {{ $index * 0.12 }}s;">
            ...
            <div class="berita-card-body">
                ...
                <a href="{{ route('bpn.berita.show', $berita->id) }}" class="btn-detail">
                    Lihat Detail
