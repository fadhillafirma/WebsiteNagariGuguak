...
<div class="max-w-4xl mx-auto px-4 py-6 md:py-10">
    ...
    <form action="{{ route('situs-lembaga.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-100 space-y-6">
        @csrf
