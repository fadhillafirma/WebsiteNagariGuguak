...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-md p-8 mt-4">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Edit Kegiatan Kalender</h1>
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('kalender.update', ['kalender_data' => $kalender->id]) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input
                    ...
                    name="jam_mulai"
                    id="jam_mulai"
                    value="{{ old('jam_mulai', $kalender->jam_mulai) }}"
                    required
                    class="w-full rounded-lg border border-gray-300 p-3 text-sm text-gray-700 focus:border-blue-400 focus:ring-2 focus:ring-blue-400">
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    name="jam_akhir"
                    id="jam_akhir"
                    value="{{ old('jam_akhir', $kalender->jam_akhir) }}"
                    required
                    class="w-full rounded-lg border border-gray-300 p-3 text-sm text-gray-700 focus:border-blue-400 focus:ring-2 focus:ring-blue-400">
            </div>
